                            ...
                            <div class="card bg-transparent shadow-xl">
                                <div class="overflow-hidden position-relative border-radius-xl">
                                    ...
                                    <div class="card-body position-relative z-index-1 p-3">
                                        ...
                                        <h5 class="text-white mt-4 mb-5 pb-2">Order_Id: {{$order_id}}</h5>
                                        <div class="d-flex">
                                            <div class="d-flex">
                                                <div class="me-4">
                                                    <p class="text-white text-sm opacity-8 mb-0">Customer Name</p>
                                                    <h6 class="text-white mb-0">{{$customer_name}}</h6>
                                                </div>
                                                <div>
                                                    <p class="text-white text-sm opacity-8 mb-0">Order at: </p>
                                                    <h6 class="text-white mb-0">{{date('d-m-Y', strtotime($order_at))}}</h6>
                                                </div>
                                            </div>
                                ...
                                <div class="col-md-6 col-6">
                                    <div class="card">
                                        ...
                                        <div class="card-body pt-0 p-3 text-center">
                                            <h6 class="text-center mb-0">Total Price</h6>
                                            <!-- <span class="text-xs">Belong Interactive</span> -->
                                            <hr class="horizontal dark my-3">
                                            <h5 class="mb-0">{{number_format($order_total_price,0,'.',',')}}đ</h5>
                                        </div>
                                    </div>
                                </div>
                                <!-- <div class="col-md-6 col-6">
                            ...
                            <ul class="list-group">
                                ...
                                <li class="list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg">
                                    ...
                                    <div class="d-flex align-items-center text-sm">
                                        {{number_format($item->price * $od->quantity,0,'.',',')}}
