      ...
      <div class="container-fluid py-1 px-3">
        ...
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
          ...
          <ul class="navbar-nav  justify-content-end">
            ...
            <li class="nav-item d-flex align-items-center" ><a href="{{route('logout.perform')}}"><i class="material-icons opacity-10">login</i></a></li>
                ...
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      ...
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Category/SubCategory</th>
                    ...
                    <tr>
                      <td>
                        <div class="d-flex px-2 py-1">
                          <div>
                            <img src="{{$image}}" class="avatar avatar-sm me-3 border-radius-lg" alt="user1">
                          </div>
                          <div class="d-flex flex-column justify-content-center">
                      ...
                      <td>
                        <?php
                        $product_id = $item->id;
                        $cate_sub = Product::GetProductCategoryAndSubcategory($product_id);
                        ?>
                        @foreach ($cate_sub as $cs)
                        <p class="text-xs font-weight-bold mb-0">{{$cs->category_name}}</p>
                        <p class="text-xs text-secondary mb-0">{{$cs->sub_category_name}}</p>
                        @endforeach
                      </td>
